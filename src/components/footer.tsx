    ...
    <footer>
      ...
      <div style={{ background: "#0f1f14", color: "#d1fae5" }}>
        <div className="container-wide py-14">
          ...
          <p className="text-xs text-center opacity-70 px-4 pb-6">Contractors Choice Agency &middot; 12220 E Riggs Road, Suite #104, Chandler, AZ 85249 &middot; NPN #8608479</p>
    </footer>
  );
}
